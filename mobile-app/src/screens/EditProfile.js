                ...
                <KeyboardAvoidingView behavior={Platform.OS == 'ios' ? "padding" : "padding"} style={styles.form}>
                    <View style={styles.containerStyle}>
                        ...
                        <View style={[isRTL? conleft: conright]}>
                            ...
                            />
                            <Input
                                editable={profileData && ((profileData.regType == 'social'&& (!profileData.email || profileData.email.length<2) ) || profileData.regType == 'mobile') ? true : false}
                                underlineColorAndroid={colors.TRANSPARENT}
                        ...
                        <View style={[isRTL? conleft: conright]}>
                            ...
                            />
                            <Input
                                editable={profileData && ((profileData.regType == 'social' &&  (!profileData.mobile || profileData.mobile.length<2)) || profileData.regType == 'email') ? true : false}
                                underlineColorAndroid={colors.TRANSPARENT}
